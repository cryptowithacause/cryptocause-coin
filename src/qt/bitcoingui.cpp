...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a cryptocause address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptocause: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about cryptocause Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your cryptocause addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified cryptocause addresses"));
    ...
    openAction->setStatusTip(tr("Open a cryptocause: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible cryptocause command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cryptocause network", "", count));
    } else {
...
{
    QString strTitle = tr("cryptocause Core"); // default title
    ...
    // Append title to "cryptocause Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
