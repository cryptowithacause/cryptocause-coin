...
//! These need to be macros, as clientversion.cpp's and cryptocause*-res.rc's voodoo requires it
...
/**
 * cryptocaused-res.rc includes this file, but it cannot cope with real c++ code.
