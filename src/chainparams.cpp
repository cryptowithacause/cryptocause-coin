...
// Copyright (c) 2020 The cryptocause Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1588154114, nBits=1e0ffff0, nNonce=1103239, vtx=1)
...
{
    const char* pszTimestamp = "nonprofit using crypto to impact the migrant crisis in Greece";
    const CScript genesisOutputScript = CScript() << ParseHex("042e2a9d955609ceadc8ecee5cb729d0ec5e22293c806254201c35204b594cb8cf3d0965b44a95eac67765cfb4677f89923ca0dbe1d26ce3e3b61dbc603b09496e") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000000e139983501471edad95f88a11fa3214704d9ebc90ab9decbbd06d38eb3"); 
        ...
        vAlertPubKey = ParseHex("04056231dfce0a6679efa676db501fa3f345c7d981cc8c78740f5a2c84674eb04ecd8b6740217484fd3ee4943a11f68c7786bbcb55686f828bd2f6e4528491569d");
        nDefaultPort = 18534;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1588154114, 1103239, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000000e139983501471edad95f88a11fa3214704d9ebc90ab9decbbd06d38eb3"));
        assert(genesis.hashMerkleRoot == uint256S("0xe611a6318f1e318038b534107ab0d032fd0f2f8a98b4dad42cab5d70b4d230b0"));


        vSeeds.push_back(CDNSSeedData("walletbuilders.com", "node1.walletbuilders.com"));
        vSeeds.push_back(CDNSSeedData("217.61.5.105", "217.61.5.105"));
        ...
        // cryptocause BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // cryptocause BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // cryptocause BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"CXcwmhpVSqQXnWww6CtPx1AfBmvrzkkszx"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x000000e139983501471edad95f88a11fa3214704d9ebc90ab9decbbd06d38eb3"))
        };

        chainTxData = ChainTxData{
            1588154114, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000291f06aed6f3ee43c55332aa5f3f39f2aefd2440401f95dff9c7fc579df"); 

        pchMessageStart[0] = 0x8e;
        pchMessageStart[1] = 0xdb;
        pchMessageStart[2] = 0xe2;
        pchMessageStart[3] = 0x1d;
        vAlertPubKey = ParseHex("045a97927903c8350770d35a82adca88f7c9f0f1ccd9118216d4bda1d9c064e881c78b7d6419f7557878e4a0aa7c1e9a6da7f2ef50d19ff3e146b69c88fa1dd1f4");
        nDefaultPort = 28534;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1588154119UL, 2110416UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000291f06aed6f3ee43c55332aa5f3f39f2aefd2440401f95dff9c7fc579df"));
        assert(genesis.hashMerkleRoot == uint256S("0xe611a6318f1e318038b534107ab0d032fd0f2f8a98b4dad42cab5d70b4d230b0"));
        ...
        // Testnet cryptocause BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet cryptocause BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet cryptocause BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"TUBankNSavJwpt1m3hG3HRWobrntfxjgWz"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000291f06aed6f3ee43c55332aa5f3f39f2aefd2440401f95dff9c7fc579df"))
        };

        chainTxData = ChainTxData{
            1588154119, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1588154124, 1, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x424413e45779e6454b62917fdfff556e89d64e9e1dcd91b513bb28e6c658b7fc"));
        assert(genesis.hashMerkleRoot == uint256S("0xe611a6318f1e318038b534107ab0d032fd0f2f8a98b4dad42cab5d70b4d230b0"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x424413e45779e6454b62917fdfff556e89d64e9e1dcd91b513bb28e6c658b7fc"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 7ULMMm18KBw4a4qFsPsLpThwsiekDSb3Lg4a7E5R5EKcaSAo2Yo
        vSporkAddresses = {"TCJuiCREw726rkYZFPoyLFbDqpULCtgvqH"};
        nMinSporkKeys = 1;
        ...
        // Regtest cryptocause addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Regtest cryptocause script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // Regtest cryptocause BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest cryptocause BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest cryptocause BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
