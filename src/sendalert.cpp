...
2. run cryptocaused with -printalert or -sendalert like this:
   /path/to/cryptocaused -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cryptocause.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/cryptocause Core:0.12.0.58/"));
