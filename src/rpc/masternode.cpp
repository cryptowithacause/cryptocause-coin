...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner cryptocause address\n"
            "  payee          - Print the masternode payout cryptocause address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting cryptocause address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "cryptocause",               "masternode",             &masternode,             true,  {} },
    { "cryptocause",               "masternodelist",         &masternodelist,         true,  {} },
    { "cryptocause",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "cryptocause",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
