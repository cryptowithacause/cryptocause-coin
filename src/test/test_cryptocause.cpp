...
#define BOOST_TEST_MODULE cryptocause Test Suite

#include "test_cryptocause.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_cryptocause_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
