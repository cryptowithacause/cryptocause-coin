...
This mechanism has been integrated into Bitcore-Node-cryptocause which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cryptocausepay/insight-api-cryptocause#web-socket-api](https://github.com/cryptocausepay/insight-api-cryptocause#web-socket-api)
* API: [https://github.com/cryptocausepay/insight-api-cryptocause#instantsend-transactions](https://github.com/cryptocausepay/insight-api-cryptocause#instantsend-transactions)
