...
This document provides guidelines for internationalization of the cryptocause Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cryptocause_en.ts` remains unchanged.
