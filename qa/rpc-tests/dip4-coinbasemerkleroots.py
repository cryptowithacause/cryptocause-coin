...
class LLMQCoinbaseCommitmentsTest(cryptocauseTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as cryptocauseTestFramework doesn't support this atm)
