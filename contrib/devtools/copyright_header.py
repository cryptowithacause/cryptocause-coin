...
EXPECTED_HOLDER_NAMES = [
    ...
    "The cryptocause Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a cryptocause Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The cryptocause Core developers'
...
Arguments:
    <base_directory> - The base directory of cryptocause Core source code repository.
"""
...
Arguments:
    <file> - A source file in the cryptocause Core repository.
"""
